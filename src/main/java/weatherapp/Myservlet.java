...
public class Myservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String apikey="5ef43881cafe171daf3b8cead0013596";
		...
		InputStream ipStream=connect.getInputStream();
		...
		long datet=json.get("dt").getAsLong()*1000;
		String date = new Date(datet).toString();
